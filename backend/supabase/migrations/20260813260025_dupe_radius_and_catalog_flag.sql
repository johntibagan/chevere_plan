-- Anti-dupe más amplio para parques (nombre similar + hasta 800 m).
-- search_sites expone is_catalog para preferir catálogo al colapsar.
...
-- Añadir is_catalog al resultado de búsqueda
