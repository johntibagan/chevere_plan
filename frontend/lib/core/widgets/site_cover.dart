...
/// Varias fotos en la ficha; en listas se usa [SiteCover] con la primera.
class SiteCoverCarousel extends StatefulWidget {
  const SiteCoverCarousel({
    super.key,
  ...
  @override
  State<SiteCoverCarousel> createState() => _SiteCoverCarouselState();
}

class _SiteCoverCarouselState extends State<SiteCoverCarousel> {
    ...
    return Stack(
      ...
      children: [
        PageView.builder(
          ...
          itemBuilder: (context, i) => SiteCover(
            imageUrl: urls[i],
            categoryHint: widget.categoryHint,
          ),
        ),
              ...
              for (var i = 0; i < urls.length; i++)
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: i == _index
                        ? AppColors.onImage
                        : AppColors.onImage.withValues(alpha: 0.4),
