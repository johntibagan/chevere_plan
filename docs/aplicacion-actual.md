...
- Busca públicos **completos** y **tus** privados completos con pin: **Place ID** exacto (pegajoso al renombrar / pin sin ficha), o **radio del perfil** (☰ Mismo sitio al guardar, default **100 m**, 50–1000) aunque el título sea distinto. Aviso suave. No borradores sin pin.
