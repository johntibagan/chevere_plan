...
- **Push FCM (cañería):** tokens en `user_fcm_tokens`; cola `notifications` → webhook → Edge Function `push`. Sin UI de “activar notificaciones” ni gatillos de Compartir aún. Detalle: mismo doc Firebase.
